...
const CENOMAR = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast.success("CENOMAR request submitted successfully!");
      navigate("/tracking");
    }, 1500);
  };
        ...
        <Card className="mx-auto max-w-2xl">
          <CardHeader>
            <div className="flex items-center gap-4">
              ...
              <div>
                <CardTitle className="text-2xl">CENOMAR Request</CardTitle>
                <CardDescription>Certificate of No Marriage</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent>
