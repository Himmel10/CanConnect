...
const BuildingPermit = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast.success("Building Permit request submitted successfully!");
      navigate("/tracking");
    }, 1500);
  };
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input id="floorArea" type="number" required />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="stories">Number of Stories</Label>
                  <Input id="stories" type="number" min="1" required />
                </div>
              </div>

              <div className="space-y-2">
                <Label htmlFor="estimatedCost">Estimated Project Cost</Label>
                <Input id="estimatedCost" type="number" required placeholder="₱0.00" />
              </div>

              <div className="space-y-2">
                <Label htmlFor="engineer">Licensed Engineer/Architect</Label>
                <Input id="engineer" required placeholder="Full name and license number" />
              </div>
